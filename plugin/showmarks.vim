...
try| sil hi ShowMarksHLl | catch /^Vim\%((\a\+)\)\?:E411/ | hi def ShowMarksHLl ctermfg=darkblue ctermbg=blue cterm=bold guifg=blue guibg=lightblue gui=bold |endtry
try| sil hi ShowMarksHLu | catch /^Vim\%((\a\+)\)\?:E411/ | hi def ShowMarksHLu ctermfg=darkblue ctermbg=blue cterm=bold guifg=blue guibg=lightblue gui=bold |endtry
try| sil hi ShowMarksHLo | catch /^Vim\%((\a\+)\)\?:E411/ | hi def ShowMarksHLo ctermfg=darkblue ctermbg=blue cterm=bold guifg=blue guibg=lightblue gui=bold |endtry
try| sil hi ShowMarksHLm | catch /^Vim\%((\a\+)\)\?:E411/ | hi def ShowMarksHLm ctermfg=darkblue ctermbg=blue cterm=bold guifg=blue guibg=lightblue gui=bold |endtry
